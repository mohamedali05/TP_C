    ...
    while (1){
        ...
        case 1:
            ...
            if (premier_bloc != NULL)
            {
                ...
                // Ajout de la transaction à ajouter en tête du premier bloc
                ...
                // Libération de la mémoire pour la transaction
        ...
        case 2:
            ...
            // Ajout d'un bloc avec un dateBlock correspondant à la date suivante et un idBlock en autoincrément
            blockchain = ajouterBlock(blockchain, date_suivante(date_du_jour));
            // Affichage de la blockchain après ajout du bloc
        ...
        case 5:
            ...
            scanf("%s", descr);
            blockchain = crediter(idetu, montant, descr, date_du_jour, blockchain);
            print_blockchain(blockchain) ;
            break;
        ...
        case 9:
            ...
            // Libérer la mémoire avant de sortir du programme pour éviter les fuites de mémoire
